...
class RpcExecutionTemplateTest {
    ...
    void shouldCallOnErrorCleanupAndPropagateCheckedException() {
        ...
        Throwable thrown =
                Assertions.assertThrows(
                        Throwable.class, () -> template.execute(context, asCallable(checked)));
    ...
    void shouldPropagateSameCheckedBusinessExceptionWithSuppressedLifecycleFailures() {
        ...
        RpcExecutionTemplate template =
                new RpcExecutionTemplate(new RpcHookChain(List.of(hook)), noOpTracer(), false);

        Throwable thrown =
                Assertions.assertThrows(
                        Throwable.class,
                        () -> template.execute(context("checked"), asCallable(primary)));

        Assertions.assertSame(primary, thrown);
        Assertions.assertArrayEquals(
                new Throwable[] {onErrorFailure, cleanupFailure}, thrown.getSuppressed());
    }
    ...
    void shouldPropagateRuntimeExceptionWithoutWrapping() {
        ...
        RuntimeException thrown =
                Assertions.assertThrows(
                        ...
                        () -> template.execute(context, asCallable(runtime)));
    ...
    void shouldPreserveBusinessOutcomeWhenPostHooksFail() {
        ...
        RuntimeException thrown =
                Assertions.assertThrows(
                        RuntimeException.class,
                        () -> template.execute(context("failure"), asCallable(primary)));
