...
class RpcCallMetadataTest {
    ...
    void shouldBuildMetadataAndCopyAttachments() {
        ...
        Assertions.assertThrows(
                ...
                () -> metadata.getAttachments().put("k2", "v2"));
    }
    ...
    void shouldValidateRequiredFields() {
        Assertions.assertThrows(
                NullPointerException.class, () -> RpcCallMetadata.builder().method("m1").build());
        Assertions.assertThrows(
                NullPointerException.class, () -> RpcCallMetadata.builder().service("svc").build());
    }
}
