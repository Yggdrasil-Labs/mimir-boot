...
class HttpServletRequestMockBuilderTest {
    ...
    void testUri() {
        HttpServletRequest request =
                HttpServletRequestMockBuilder.create().uri("/api/user/123").build();
    ...
    void testQueryString() {
        HttpServletRequest request =
                HttpServletRequestMockBuilder.create().queryString("name=test&age=20").build();
    ...
    void testQueryString_Null() {
        HttpServletRequest request =
                HttpServletRequestMockBuilder.create().queryString(null).build();
    ...
    @Test
    void testMethod() {
        HttpServletRequest request = HttpServletRequestMockBuilder.create().method("POST").build();
    ...
    void testUserAgent() {
        HttpServletRequest request =
                HttpServletRequestMockBuilder.create().userAgent("Mozilla/5.0").build();
    ...
    void testRemoteAddr() {
        HttpServletRequest request =
                HttpServletRequestMockBuilder.create().remoteAddr("192.168.1.100").build();
    ...
    void testHeader() {
        HttpServletRequest request =
                HttpServletRequestMockBuilder.create()
    ...
    void testDefaultIpHeaders() {
        HttpServletRequest request =
                HttpServletRequestMockBuilder.create().defaultIpHeaders().build();
    ...
    void testBuild_WithoutIpHeaders() {
        HttpServletRequest request =
                HttpServletRequestMockBuilder.create().uri("/api/test").build();
