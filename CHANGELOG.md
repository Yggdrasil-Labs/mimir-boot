...
* **mybatis:** 扩展 SQL 敏感字段脱敏 ([a329d24](https://github.com/Yggdrasil-Labs/mimir-boot/commit/a329d2458f68fc46b7ff364ba2998b50b01ab6a3))
* **nacos:** 修复解密门控与遗留密文告警 ([5e71294](https://github.com/Yggdrasil-Labs/mimir-boot/commit/5e7129408cbe14e3c6d4031e879c29a28c80cad4))
* **release:** 修复稳定版制品校验并补充契约测试 ([a89b560](https://github.com/Yggdrasil-Labs/mimir-boot/commit/a89b560790ff0c9d539f1cd510dffffebc9838ca))
...
* **starters:** 修复日志安全与请求链路一致性 ([9874ea4](https://github.com/Yggdrasil-Labs/mimir-boot/commit/9874ea4493f6323efe674de2418e30014ee215df))
...
* **web:** 保持异步请求链路标识 ([1e7c377](https://github.com/Yggdrasil-Labs/mimir-boot/commit/1e7c377ccb15e7cd5cbbcde8fb664233805daac9))
* **web:** 接入响应增强并保留下游 MVC 定制能力 ([30c47c8](https://github.com/Yggdrasil-Labs/mimir-boot/commit/30c47c88196d97d20b8d84faefa4e790b11b318d))
* **web:** 清理异步请求 MDC 上下文 ([4bd5cd0](https://github.com/Yggdrasil-Labs/mimir-boot/commit/4bd5cd00de729f847fa905b69d6cc003e92bd6f5))
* 修复发布产物契约与Dubbo异步追踪 ([1d5a2ba](https://github.com/Yggdrasil-Labs/mimir-boot/commit/1d5a2ba3b1339c33bd0ca8c6c11099cd3167b1d5))
...
* **log:** 校正环境日志输出说明 ([a1a7861](https://github.com/Yggdrasil-Labs/mimir-boot/commit/a1a7861742be5884e8705f47b20f09647698e4a4))
...
* **tech-debt:** 登记高风险待修复项 ([020a736](https://github.com/Yggdrasil-Labs/mimir-boot/commit/020a7362fec513259c9937e9f0431217f7ce5459))
...
* **dubbo:** 补充异步追踪故障回归覆盖 ([1e9513b](https://github.com/Yggdrasil-Labs/mimir-boot/commit/1e9513b236d0e41ebd21045ab3075dff5c780da2))
* **exception:** 覆盖解析异常日志脱敏 ([2990d73](https://github.com/Yggdrasil-Labs/mimir-boot/commit/2990d73227317a7d0d57aa11921ae7adfd13e75c))
...
* **bom:** 升级 Lombok 与 Protobuf ([2e546ca](https://github.com/Yggdrasil-Labs/mimir-boot/commit/2e546cab4289d922bdf905fd79d349e60da234d3))
* **parent:** 升级 Maven 构建插件 ([789b878](https://github.com/Yggdrasil-Labs/mimir-boot/commit/789b878bda4c74b930e9fd66ff8962fc541668da))
* **release:** 修复发布制品继承与部署配置 ([8e602d8](https://github.com/Yggdrasil-Labs/mimir-boot/commit/8e602d89d259d6a096fb8c0e24314ad790cf239b))
* 修复签名默认值与依赖元数据 ([a5dba88](https://github.com/Yggdrasil-Labs/mimir-boot/commit/a5dba884503a0381c8d02818729861f01ca28e00))


### 👷 Continuous Integration

* **release:** 接入发布消费者验收门禁 ([af1bf75](https://github.com/Yggdrasil-Labs/mimir-boot/commit/af1bf755d84a55da59e9738bc2fb716510f4acb8))
* **release:** 更新 GitHub 发布动作 ([11afb07](https://github.com/Yggdrasil-Labs/mimir-boot/commit/11afb07e632471cf4dee3b0c6555b474d689bed7))
...
* **deps:** 升级 Springdoc OpenAPI 至 2.9.1 ([b0885b5](https://github.com/Yggdrasil-Labs/mimir-boot/commit/b0885b53d6bb65bb19d99e3e9608afd6368c85bd))
...
* **deps:** 将 spotless 与 Maven 发行版/Wrapper 纳入 maven-plugins 分组 ([0634d4c](https://github.com/Yggdrasil-Labs/mimir-boot/commit/0634d4c0c17cb88c4ad2807b5689260688a3eb83))
* **deps:** 更新 GitHub Actions 至 checkout v6.1.0、setup-java v5.7.0、markdownlint v24.2.0 ([cbf6e92](https://github.com/Yggdrasil-Labs/mimir-boot/commit/cbf6e925504ac7a2504dd95ebc7859cca80ea0af))
...
* **deps:** 升级 BOM 中 fastjson2、springdoc 与 commons-collections4 ([090ca25](https://github.com/Yggdrasil-Labs/mimir-boot/commit/090ca256df84f8c49476e80b59476b4646b84bd1))
* **deps:** 升级 maven-wrapper 至 3.3.4 并采用 Maven 3.9.16 ([67b5836](https://github.com/Yggdrasil-Labs/mimir-boot/commit/67b5836621e388be6e334016e9254ddffcd54e2e))
* **deps:** 升级 spotless-maven-plugin 至 3.9.0 ([a17687a](https://github.com/Yggdrasil-Labs/mimir-boot/commit/a17687aa0afe16563cdcff3a3789a7319f929018))
