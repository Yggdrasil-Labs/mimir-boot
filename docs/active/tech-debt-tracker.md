...
| TD-010 | rpc | Feign 包装可能绕过用户配置的 Client（Dubbo Provider 入站追踪提取已由 R-008 于 2026-07-22 修复） | 高 | 2026-07-17 | ORPHAN | [能力复审修复清单](./capability-review-2026-07/fix-checklist.md#phase-2修复-rpc-传播语义) |
