...
| TD-008 | security | 访问日志会记录 query string 并缓存完整响应，可能泄露敏感数据或破坏流式响应语义；CORS、Nacos 与 SQL 日志问题已在当前分支修复 | 高 | 2026-07-17 | ORPHAN | [能力复审修复清单](./capability-review-2026-07/fix-checklist.md#phase-1修复安全默认值与敏感数据泄露) |
